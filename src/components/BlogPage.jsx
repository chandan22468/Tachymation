...
const BlogPage = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-[#a1a1aa] font-sans selection:bg-white/30 selection:text-white pb-24">
      ...
      <header className="relative w-full pt-32 pb-16 px-4 sm:px-8 md:px-16 max-w-[1200px] mx-auto border-b border-white/10">
        ...
        <div className="flex flex-wrap items-center gap-6 text-sm text-[#a1a1aa] font-light">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 md:px-16 mt-12 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-16 items-start">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          {/* Featured Image */}
          <div className="w-full aspect-[16/9] mb-12 rounded-lg overflow-hidden relative bg-border border border-white/10">
            <img 
          ...
          <p className="text-xl md:text-2xl text-[#a1a1aa] leading-relaxed font-light mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {['Make & Zapier', 'OpenAI & Anthropic APIs', 'n8n', 'Iterate First'].map((tool) => (
              <div key={tool} className="p-4 rounded-xl bg-white/[0.02] border border-white/10 flex items-center justify-center text-center">
          ...
          <ol className="mb-6 space-y-4 list-decimal pl-6 marker:text-white/50 text-[#a1a1aa]">
          ...
          <div className="px-8 py-8 rounded-lg bg-white/[0.02] border border-white/10 mb-16 leading-relaxed">
        ...
        <aside className="hidden lg:block relative">
          <div className="sticky top-32 p-6 rounded-lg bg-white/[0.02] border border-white/10">
            ...
            <nav className="flex flex-col gap-3 text-sm">
              {tableOfContents.map((item) => (
                <a 
                  key={item.id} 
                  href={`#${item.id}`}
                  className="text-[#a1a1aa] hover:text-white transition-colors duration-200 line-clamp-1"
                >
                  {item.title}
                </a>
              ))}
            ...
            <div className="mt-8 pt-8 border-t border-white/10">
              <p className="text-xs text-[#a1a1aa] mb-4">Want to automate your own workflows?</p>
              <a href="#" className="inline-flex items-center text-xs font-bold text-white hover:text-[#a1a1aa] transition-colors group">
      ...
      <section className="max-w-[1200px] mx-auto px-4 sm:px-8 md:px-16 mt-24">
        <div className="w-full rounded-[2rem] bg-gradient-to-br from-white/10 to-white/[0.02] border border-white/10 p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="text-lg text-[#a1a1aa] mb-10 max-w-2xl mx-auto relative z-10 font-light">
