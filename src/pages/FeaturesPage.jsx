...
const features = [
  {
    ...
    description:
      "Iterate First's AI Build Engine takes your brief — a doc, a Figma file, a voice note — and generates production-ready web platforms. Landing pages for fintech clients, e-commerce stores with 80+ products, real-time analytics dashboards — all built and deployed by AI automation tools.",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "Iterate First's workflow automation engine integrates your entire business stack — CRM, ERP, Slack, email, databases — into a single intelligent pipeline. We automate business processes including invoice reconciliation, data entry, report generation, lead routing, and customer onboarding. Zero human intervention required.",
    capabilities: [
      'CRM → ERP → Slack sync',
  ...
  },
  {
    ...
    tagline: 'Legacy or modern — Iterate First connects everything.',
    description:
      'For enterprise teams, Iterate First builds bespoke system integration layers that connect legacy infrastructure with modern cloud services. Our AI automation platform handles multi-system orchestration, compliance workflows, and real-time data pipelines without requiring you to rebuild your existing stack.',
    capabilities: [
  ...
  },
  {
    ...
    description:
      'Every Iterate First system includes built-in analytics and adaptive logic. The platform monitors automation performance, surfaces bottlenecks, and continuously optimises workflows. This is AI automation that gets smarter the longer it runs — turning your business processes into self-improving systems.',
    capabilities: [
...
const FeaturesPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Iterate First Features - Automate Business Workflows with AI"
        description="Explore Iterate First's AI automation features: workflow automation engine, AI build engine for websites, enterprise integration, and adaptive automation intelligence. Automate your business processes today."
        canonical="/features"
      />
