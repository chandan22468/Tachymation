    ...
    <>
      ...
      <main className="w-full bg-black text-white min-h-screen pt-32 pb-24 px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-[#a1a1aa] font-light leading-relaxed mb-16 max-w-2xl">
            <strong className="text-white font-medium">Iterate First</strong> is an AI automation platform
          ...
          <section aria-labelledby="values-heading" className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={v.title} className="p-8 border border-white/10 rounded-lg bg-white/[0.02]">
          ...
          <section aria-labelledby="stats-heading" className="mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={s.label} className="p-6 border border-white/10 rounded-lg bg-white/[0.02] text-center">
                  <p className="text-3xl md:text-4xl font-black text-white mb-2">{s.value}</p>
                  <p className="text-xs text-[#a1a1aa]/60 uppercase tracking-widest">{s.label}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="border-t border-white/10 pt-12">
            <h2 className="text-xl font-bold text-white mb-6">Explore Iterate First</h2>
