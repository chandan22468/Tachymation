...
const cases = [
  ...
  },
  {
    ...
    body: "For startups and scale-ups, Tachymation is the unfair advantage. Instead of hiring a full engineering team or waiting months for an agency, founders use Tachymation to ship web platforms, automate their operations, and build internal tools — all without writing a line of code. Tachymation's AI automation tools are built for teams that need to move fast and can't afford to slow down.",
    examples: [
      ...
      <main className="w-full bg-[#050505] text-white min-h-screen pt-32 pb-24 px-6 md:px-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-gray-400 font-light leading-relaxed mb-16 max-w-2xl">
            From solo founders to enterprise teams — Tachymation is the AI automation platform
            that replaces repetitive work across every layer of your business. These are the
            real ways businesses use Tachymation's AI automation tools to move faster and operate
            smarter.
          </p>
          ...
          <div className="mt-16 p-8 md:p-10 rounded-3xl border border-white/5 bg-white/[0.02] text-center">
            ...
            <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto leading-relaxed mb-8">
              Unlike no-code workflow builders or generic automation tools, Tachymation handles
              ...
              processes with real intelligence — they choose Tachymation.
            </p>
